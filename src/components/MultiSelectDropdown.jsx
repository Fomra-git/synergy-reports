...
export default function MultiSelectDropdown({ options, selectedValues, onChange, placeholder = "Select values...", disabled = false }) {
  ...
  return (
    <div className="multi-select-dropdown" ref={wrapperRef} style={{ position: 'relative', width: '100%', flex: 1 }}>
      <div 
            ...
            {filteredOptions.length === 0 ? (
              ...
              filteredOptions.map((opt, i) => (
                <li 
                  ...
                  onMouseOut={(e) => {
                    e.currentTarget.style.background = selectedValues.includes(opt) ? 'rgba(99, 102, 241, 0.1)' : 'transparent';
                  }}
                >
